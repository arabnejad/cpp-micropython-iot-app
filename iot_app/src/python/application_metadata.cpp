...
ApplicationMetadata parseApplicationMetadata(const std::string &metadataJson) {
  ...
  ApplicationMetadata metadata{
      ...
      iot::internal::requireNonEmptyJsonStringField(metadataObject.get(), "name", "Application metadata"),
      iot::internal::requireNonEmptyJsonStringField(metadataObject.get(), "entry_point", "Application metadata")};
